...
use Lak\TestBundle\Entity\Book;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Book')->findAll();

        return $this->render('TestBundle:Book:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TestBundle:Book:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Book')->find($id);
...
//        $permision=isGranted('view', $entity);
        $this->denyAccessUnlessGranted('view', $entity, 'Unauthorized access!');
        
        return $this->render('TestBundle:Book:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TestBundle:Book:edit.html.twig', array(
            'entity'      => $entity,
