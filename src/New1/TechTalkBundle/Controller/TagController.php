...
use New1\TechTalkBundle\Entity\Tag;
use New1\TechTalkBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('New1TechTalkBundle:Tag')->findAll();

        return $this->render('New1TechTalkBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('New1TechTalkBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('New1TechTalkBundle:Tag')->find($id);
        ...
        return $this->render('New1TechTalkBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('New1TechTalkBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
